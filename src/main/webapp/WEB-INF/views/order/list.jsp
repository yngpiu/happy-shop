...
uri="http://java.sun.com/jstl/fmt_rt" prefix="f"%> <%@ taglib prefix="fmt"
          ...
          <div class="row">
            <div class="col-sm-2">
              <i
                ...
                style="font-size: 30px; padding: 12px 5px; color: black"
              ></i>
            </div>
            ...
            <div class="row">
              <div class="col-sm-2">
                <i
                  ...
                  style="font-size: 30px; padding: 12px 5px; color: brown"
                ></i>
              </div>
              <div class="col-sm-10" style="padding: 0px 15px">
                <span>
            ...
            <tbody>
              <c:forEach var="o" items="${orders}">
                <tr>
                  ...
                  <td>${o.address }</td>
                  <td>
                    <f:formatNumber value="${o.amount}" pattern="#,###" /> VNĐ
                  </td>
                  <td>
                    <a
                      href="/order/detail/${o.id}"
