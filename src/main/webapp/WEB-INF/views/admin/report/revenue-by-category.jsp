...
<div class="row mb-4">
    ...
    <div class="card shadow mb-4">
      ...
      >
        <h6 class="m-0 font-weight-bold text-primary">
          <i class="fas fa-chart-pie me-2"></i>Phân bố Doanh thu theo Loại
        </h6>
  ...
  <div class="col-xl-6 col-lg-6">
    <div class="card shadow mb-4">
      ...
      >
        <h6 class="m-0 font-weight-bold text-primary">
          <i class="fas fa-chart-column me-2"></i>So sánh Doanh thu & Số lượng
        </h6>
        <div class="dropdown no-arrow">
          <a
            class="dropdown-toggle"
          ...
          >
            ...
            <a class="dropdown-item" href="#" onclick="toggleBarChart('bar')"
              >Biểu đồ cột</a
            >
            <a class="dropdown-item" href="#" onclick="toggleBarChart('line')"
              >Biểu đồ đường</a
            >
          </div>
        </div>
      ...
      >
        <thead class="table">
          <tr>
            ...
            <th><i class="fas fa-dollar-sign me-1"></i>Tổng doanh thu</th>
            ...
            <tr>
              ...
              <td>
                ...
                <span class="text-primary font-weight-bold">
                  <f:formatNumber value="${revenuePerItem}" pattern="#,###" />
                  VNĐ
                </span>
              </td>
            </tr>
...
<script>
  ...
  // Doughnut Chart
  const doughnutCtx = document.getElementById('revenueChart').getContext('2d');
      ...
      datasets: [
        {
          ...
          data: revenueData.revenues.map(r => r / 1000000),
          ...
          callbacks: {
            label: function (context) {
              ...
              if (context.datasetIndex === 0) {
                label += (context.raw * 1000000).toLocaleString() + ' VNĐ';
              } else {
