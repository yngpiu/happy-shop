    ...
    <div class="card bg-primary text-white h-100">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <h6 class="card-title text-white mb-1">Tổng số loại</h6>
            <h3 class="mb-0">${totalCategories}</h3>
            <small class="text-white">loại sản phẩm</small>
          </div>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            ...
            <small class="text-white">loại đang sử dụng</small>
          </div>
          <div class="text-white">
  ...
  <div class="col-12 col-md-3 mb-3">
    <div class="card bg-info text-white h-100">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <h6 class="card-title text-white mb-1">Có sản phẩm</h6>
            <h3 class="mb-0">${categoriesWithProducts}</h3>
            <small class="text-white">loại có sản phẩm</small>
          </div>
          <div class="text-white">
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            ...
            <small class="text-white">đã xóa tạm thời</small>
          </div>
          <div class="text-white">
